...
*/
    ...
    void Awake()
    {
        ...
        this.CreateTextMesh();
        if (GetComponent<LocalisedString>() != null) GetComponent<LocalisedString>().Start();
        if (textGO != null)
    ...
    {
        if (meshRenderer == null || meshRenderer.bounds == null || meshRenderer.bounds.center == null) return new Rect();
...
#if UNITY_EDITOR
        UnityEngine.Profiling.Profiler.BeginSample("UpdateText");
