...
namespace SBS.Level
{
	public class LevelPreprocessor
	{
        ...
        protected object ParseAttribute(string value, Type type)
        {
            ...
            {
//                //.Assert(false, "Invalid type " + type.ToString());
                obj = null;
            }
...
//                    //.Assert(desc.type != null, "Cannot find class \"" + child.Attributes["name"].Value + "\"");
...
//            //.Assert("SetupLevel" == root.Name, "Invalid LevelRoot xml");
            ...
            foreach (XmlNode child in root.ChildNodes)
            {
                ...
                {
//                    //.Assert(false, "Invalid LevelRoot xml tag \"" + child.Name + "\"");
                }
            }
