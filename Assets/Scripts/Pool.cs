 ...
 * old without randomicity: always the firstobject if ratio is low
    ...
    public void SetFreeObject(GameObject freedObject)
    {
        ...
        //.Assert(false, "Pool.SetFreeObject() - object with name \"" + freedObject.name + "\" not found in this pool. POOL STATUS: " + poolStatus);
    }
    ...
    public void SetUsedObject(GameObject freedObject)
    {
        ...
        //.Assert(false, "Pool.SetUsedObject() - object with name \"" + freedObject.name + "\" not found in this pool. POOL STATUS: " + poolStatus);
    }
}