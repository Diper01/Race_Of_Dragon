...
public class OnTheRunCoinsService : Manager<OnTheRunCoinsService>
{
    ...
    void Update()
    {
      ...
      //  PlayerPersistentData.Instance.IncrementCurrency(PriceData.CurrencyType.SecondCurrency, 100);
       // PlayerPersistentData.Instance.IncrementCurrency(PriceData.CurrencyType.FirstCurrency, 100);
    }
	void Init()
	{
        Log("Init");
