...
public class OnTheRunInAppManager : MonoBehaviour
{
    ...
    void InitializeDiamondIdsByButtonIndex()
    {
		...
		diamondIdsByButtonIndex.Add(5, "buy.iap.0.99");
		diamondIdsByButtonIndex.Add(4, "buy.iap.1.99");
		diamondIdsByButtonIndex.Add(3, "buy.iap.5.99");
		diamondIdsByButtonIndex.Add(2, "buy.iap.10.99");
		diamondIdsByButtonIndex.Add(1, "buy.iap.49.99");
		diamondIdsByButtonIndex.Add(0, "buy.iap.89.99");
    }
    ...
    {
        //.Assert(diamondIdsByButtonIndex.ContainsKey(buttonIndex), "OnTheRunInAppManager.IsPriceAvailableForPurchaseButton(" + buttonIndex + ", currency: " + currency + ")");
    ...
    {
        //.Assert(diamondIdsByButtonIndex.ContainsKey(buttonIndex), "OnTheRunInAppManager.GetCostForPurchaseButton(" + buttonIndex + ")");
    ...
    {
        //.Assert(coinIdsByButtonIndex.ContainsKey(buttonIndex), "OnTheRunInAppManager.GetCostForPurchaseButton(" + buttonIndex + ")");
    ...
    public void PurchaseProduct(int buttonIndex, int quantity, PriceData.CurrencyType currency)
    {
        ...
        {
            case PriceData.CurrencyType.FirstCurrency:
                //.Assert(coinIdsByButtonIndex.ContainsKey(buttonIndex), "OnTheRunInAppManager.PurchaseProduct(" + buttonIndex + ")");

                productId = coinIdsByButtonIndex[buttonIndex];
                break;

            case PriceData.CurrencyType.SecondCurrency:
                //.Assert(diamondIdsByButtonIndex.ContainsKey(buttonIndex), "OnTheRunInAppManager.PurchaseProduct(" + buttonIndex + ")");
