...
//                OnTheRunOmniataManager.Instance.TrackTutorialStepFinished(TutorialType.Trucks);
    ...
    IEnumerator InitialTutorialPopupDelayed( )
    {
        ...
        uiManager.FrontPopup.gameObject.transform.Find("content/popupTitle").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("popup_tutorial_warning_title");
        uiManager.FrontPopup.gameObject.transform.Find("content/popupTextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("popup_tutorial_warning");
        uiManager.FrontPopup.transform.Find("content/OkButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("ok");
    ...
    protected void ShowTutorialPopup(string text, string titleText = null)
    {
        ...
        if (tutPopup==null)
            tutPopup = Manager<UIRoot>.Get().transform.Find("TutorialPopup").gameObject;

        tutPopup.GetComponent<UIPopup>().pausesGame = !OnTheRunTutorialManager.TUTORIAL_WITH_SLOWMOTION;

        uiManager.PushPopup(popupToShow);
        uiManager.FrontPopup.gameObject.transform.Find(popupTextfield).GetComponent<UITextField>().text = text;
		if (titleText == null)
        	uiManager.FrontPopup.gameObject.transform.Find(popupTitle).GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("popup_tutorial_title");
		else
			uiManager.FrontPopup.gameObject.transform.Find(popupTitle).GetComponent<UITextField>().text = titleText;
