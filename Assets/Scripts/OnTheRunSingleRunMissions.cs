...
public class OnTheRunSingleRunMissions : MonoBehaviour
{
    ...
    public class DriverMission
    {
        ...
        public void updateMission(bool forceUpdateCounter = true)
        {
            ...
            else
            {
                ...
                // --- ����� ��������� ��� �������� ������ 1 --- //
                string numberInString = Manager<UIRoot>.Get().FormatTextNumber(checkCounter);

                double val = Convert.ToDouble(numberInString);
                if (val > 1)
                {
                    if (prefix == "Collect") prefix = "Collects";
                    if (postfix == "coins") postfix = "coines";

                    if (prefix == "Collect") prefix = "Collects";
                    if (postfix == "big coins") postfix = "big coines";
                }
                description = prefix + " " + numberInString + " " + postfix;
                // --------------------------------------------- //
    ...
    void Awake()
    {
        ...
        missionsPanel = Manager<UIManager>.Get().gameObject.transform.Find("UI/MissionsPanel");
