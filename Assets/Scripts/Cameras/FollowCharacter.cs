...
public class FollowCharacter : MonoBehaviour
{
    ...
    protected SBS.Core.Tuple<Vector3, Vector3> interpOffsets;
    ...
    void Start()
    {
        ...
        playerRoot = player.transform.Find("player/ROOT");
    ...
    void InterpolateTo(SBS.Core.Tuple<Vector3, Vector3> sourceTarget, float duration = 1.0f)
    {
        interpolating = true;
