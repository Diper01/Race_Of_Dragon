...
public class UIRoot : Manager<UIRoot>
{
	...
	public UIButton HomeButton
	{
		get
		{
			if( m_pHomeButton == null )
				m_pHomeButton = UITopLeftObjects.transform.Find("btHome").gameObject.GetComponent<UIButton>();
	...
	public UIButton FuelPlusButton
	{
		get
		{
            if (m_pFuelPlusButton == null)
                m_pFuelPlusButton = UICurrenciesGO.transform.Find("FuelItem").gameObject.GetComponentInChildren<UIButton>();
	...
	public UIButton DiamondsPlusButton
	{
		get
		{
			if( m_pDiamondsPlusButton == null )
				m_pDiamondsPlusButton = UICurrenciesGO.transform.Find("DiamondsItem").gameObject.GetComponentInChildren<UIButton>();
	...
	public UIButton CoinPlusButton
	{
		get
		{
			if( m_pCoinPlusButton == null )
				m_pCoinPlusButton = UICurrenciesGO.transform.Find("CoinsItem").gameObject.GetComponentInChildren<UIButton>();
	...
	public void DisablePlusButtons()
	{
        ...
        FuelPlusButton.transform.Find("icon_more").GetComponent<SpriteRenderer>().color = new Color(1.0f, 1.0f, 1.0f, 0.5f);
        ...
        CoinPlusButton.transform.Find("icon_more").GetComponent<SpriteRenderer>().color = new Color(1.0f, 1.0f, 1.0f, 0.5f);
	}
	//------------------------------------//
	public void EnablePlusButtons()
    {
        ...
        FuelPlusButton.transform.Find("icon_more").GetComponent<SpriteRenderer>().color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        CoinPlusButton.transform.Find("icon_more").GetComponent<SpriteRenderer>().color = new Color(1.0f, 1.0f, 1.0f, 1.0f);
	}
	//------------------------------------//
    ...
    new void Awake()
    {
        ...
        UIHUDGO = transform.Find("IngamePage").gameObject;
        UICurrenciesGO = transform.Find("CurrencyBar").gameObject;
        UIButtonsBar = transform.Find("ButtonsBar").gameObject;
        UITopLeftObjects = transform.Find("TopLeftObjects").gameObject;
        UIArrows = transform.Find("ArrowsButtons").gameObject;
        UIMarks = transform.Find("PagesMarks").gameObject;
        UIExperienceBar = UITopLeftObjects.transform.Find("LevelBar").gameObject;

        OffgameBackground = transform.Find("OffgameBG/BgCentral").gameObject;

        changingBackground = transform.Find("OffgameBG/BgCentral/bg");
        changingBackgroundCenter = transform.Find("OffgameBG/BgCentral/bg/Center").GetComponent<SpriteRenderer>();
        changingBackgroundTop = transform.Find("OffgameBG/BgCentral/bg/Up").GetComponent<SpriteRenderer>();
        changingBackgroundBottom = transform.Find("OffgameBG/BgCentral/bg/Down").GetComponent<SpriteRenderer>();
        ...
        if (UITopLeftObjects.transform.Find("btHome").gameObject != null && OnTheRunBackButtonManager.Instance != null)
            OnTheRunBackButtonManager.Instance.SetHomeButton(UITopLeftObjects.transform.Find("btHome").GetComponent<UIHomeButton>());
    }
    ...
    {
        GameObject coinsBar = UICurrenciesGO.transform.Find("CoinsItem").gameObject;
        coinsBar.transform.Find("ValueTextField").GetComponent<UITextField>().text = FormatTextNumber((int)PlayerPersistentData.Instance.Coins);

        GameObject diamondsBar = UICurrenciesGO.transform.Find("DiamondsItem").gameObject;
        diamondsBar.transform.Find("ValueTextField").GetComponent<UITextField>().text = FormatTextNumber(PlayerPersistentData.Instance.Diamonds);
    ...
    {
        UITopLeftObjects.transform.Find("btHome").gameObject.SetActive(homeVisible);
        UITopLeftObjects.transform.Find("LevelBar").gameObject.SetActive(barVisible);
    }

    public void MoveHomeButton(UIEnterExitAnimations.AnimationType type)
    {
        Transform homeBut = UITopLeftObjects.transform.Find("btHome");
    ...
    public void OpenHelpPopup( )
    {
        ...
        if (TimeManager.Instance.MasterSource.IsPaused)
        {
            ...
            uiManager.FrontPopup.gameObject.transform.Find("content").transform.localPosition = Vector3.zero;
        }
        else
            OnTheRunUITransitionManager.Instance.OpenPopup("HelpPopup");

        uiManager.FrontPopup.gameObject.transform.Find("content/moveTitle").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_directions");
        uiManager.FrontPopup.gameObject.transform.Find("content/collectTitle").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_collectbolts");
        uiManager.FrontPopup.gameObject.transform.Find("content/collectText").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_bolttext");
        uiManager.FrontPopup.gameObject.transform.Find("content/slipstreamTitle").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_slipstream");
        uiManager.FrontPopup.gameObject.transform.Find("content/trucksTitle").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_trucks");

        uiManager.FrontPopup.gameObject.transform.Find("content/slipstreamDesc").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_slipstreamtext");
        uiManager.FrontPopup.gameObject.transform.Find("content/trucksDesc").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_truckstext");

        uiManager.FrontPopup.gameObject.transform.Find("content/OkButton/tfTextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_help_back");
        uiManager.FrontPopup.gameObject.transform.Find("content/OkButton/tfTextField").GetComponent<UITextField>().ApplyParameters();
    ...
    public void ShowAreYouSurePopup(AreYouSureType type, GameObject target = null)
    {
        ...
        UIButton okButton = popup.Find("content/OkButton").GetComponent<UIButton>();
        UIButton cancelButton = popup.Find("content/CancelButton").GetComponent<UIButton>();
        okButton.transform.Find("TextField").GetComponent<UITextField>().text = okText;
        popup.Find("content/CancelButton/TextField").GetComponent<UITextField>().text = cancelText;
        popup.Find("content/popupTextField").GetComponent<UITextField>().text = popupText;
        okButton.transform.Find("TextField").GetComponent<UITextField>().ApplyParameters();
    ...
    {
        transform.Find("OffgameBG/BgCentral/bg").gameObject.SetActive(visible);
    }

    public void ShowStartPageBG(bool visible)
    {
        transform.Find("OffgameBG/BGStartPage").gameObject.SetActive(visible);
    }

    public void ShowPageBorders(bool visible)
    {
        transform.Find("OffgameBG/BgDown").gameObject.SetActive(visible);
        transform.Find("OffgameBG/BGup").gameObject.SetActive(visible);
    }

    public void ShowMainLogo(bool visible)
    {
        transform.Find("StartPage/Logo/otr_logo_main").gameObject.SetActive(visible);
    }
    ...
    {
        transform.Find("RewarBottomBar").gameObject.SetActive(visible);
        ...
        transform.Find("RewarBottomBar/BottomCenterAnchor/BestLabelTextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("tips_tip" + tipRandomId);
        transform.Find("RewarBottomBar/BottomCenterAnchor/BestLabelTextField").gameObject.SetActive(tipsVisible);

        transform.Find("RewarBottomBar/BottomLeftAnchor/HallButton/text").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("garage");
        transform.Find("RewarBottomBar/BottomLeftAnchor/SpinWheelButton/text").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("spin");
        transform.Find("RewarBottomBar/BottomRightAnchor/PlayButton/TextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("btPlay");
        transform.Find("RewarBottomBar/BottomLeftAnchor/btRankings/tfLabel").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("ranking");

        UpdateSpinWheelButton();
        SetupWheelButtonBounce(transform.Find("RewarBottomBar/BottomLeftAnchor/SpinWheelButton").gameObject);
    }
    ...
    public void UpdateSpinWheelButton()
    {
        ...
        {
            transform.Find("RewarBottomBar/BottomLeftAnchor/SpinWheelButton/Remaining").gameObject.SetActive(true);
            transform.Find("RewarBottomBar/BottomLeftAnchor/SpinWheelButton/Remaining/tfRemaining").GetComponent<UITextField>().text = remainingSpinds.ToString();
        }
        else
            transform.Find("RewarBottomBar/BottomLeftAnchor/SpinWheelButton/Remaining").gameObject.SetActive(false);
    }

    public void ShowRewardBarLeftButtons(bool visible)
    {
        transform.Find("RewarBottomBar/BottomLeftAnchor").gameObject.SetActive(visible);
    }
    ...
    {
        GameObject alert = button.transform.Find("Alert").gameObject;
        alert.SetActive(activate);
    }
...
*/
    ...
    public void CreateUICamera()
    {
        ...
        UIManager uiManager = Manager<UIManager>.Get();
        GameObject uiButtonsBar = GameObject.Find("UI").transform.Find("ButtonsBar").gameObject;
