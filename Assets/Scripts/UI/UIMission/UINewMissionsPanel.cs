...
public class UINewMissionsPanel : MonoBehaviour
{
    ...
    public void UpdatePanel(OnTheRunSingleRunMissions.DriverMission currentMission)
    {
        if (diamondIcon == null)
        {
            diamondIcon = transform.Find("RightSide/diamond").gameObject;
            specialText = transform.Find("RightSide/diamond/tape_new_mission/special_text").GetComponent<UITextField>();
        }

        transform.Find("RightSide/diamond/tape_new_mission").gameObject.SetActive(false);
        rewardValue.text = "";
...
//		titleText.ApplyParameters();
        ...
        //Debug.Log("--- currentMission.description: " + currentMission.description);
...
//        specialText.ApplyParameters();
    ...
    public void UpdateRewardPanel(OnTheRunSingleRunMissions.DriverMission currentMission, bool isOnReward)
    {
        if (diamondIcon == null)
        {
            diamondIcon = transform.Find("diamond").gameObject;
            specialText = transform.Find("diamond/tape_new_mission/special_text").GetComponent<UITextField>();
        }
...
//            specialText.ApplyParameters();
    ...
    {
        OnTheRunFireworks.Instance.StartFireworksEffect(5, Manager<UIManager>.Get().ActivePage.gameObject.transform.Find("fireworks_mission"));
        rewardText.text = "";
        rewardValue.text = "";
