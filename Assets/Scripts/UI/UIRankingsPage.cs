...
public class UIRankingsPage : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        buttonsData = gameObject.transform.Find("TopCenterButtons/ToggleData").GetComponentsInChildren<UIButton>();
        scroller = transform.Find("Scroller/RankingScroller").GetComponent<UIScroller>();
        ...
        UITextField loginButtonText = loginPanel.transform.Find("btAccept/tfTextfield").GetComponent<UITextField>();
    ...
    void Start()
    {
        ...
        uiToggle = gameObject.transform.Find("TopCenterButtons/ToggleData").GetComponent<UIToggleButton>();
        uiToggle.SetActiveButton(uiToggle.firstActive.GetComponent<UIButton>()); 
        ChangeButtonColor(uiToggle.firstActive, Color.yellow);

        SetScoreTypeAndFilterToDefault();

        transform.Find("TopCenterButtons/ToggleArea/CountryButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("country");
        transform.Find("TopCenterButtons/ToggleArea/FriendsButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("friends");
        transform.Find("TopCenterButtons/ToggleArea/GlobalButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("global");

        transform.Find("TopCenterButtons/ToggleData/AllTimeButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("all_time");
        transform.Find("TopCenterButtons/ToggleData/MonthlyButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("monthly");
        transform.Find("TopCenterButtons/ToggleData/WeeklyButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("weekly");
    ...
    void SetupLoginPanel(int friendsShownCount)
    {
        ...
        if (showFriends)
        {
            ...
            UITextField text = loginPanel.transform.Find("LabelTextField").GetComponent<UITextField>();
            UIButton button = loginPanel.transform.Find("btAccept").GetComponent<UIButton>();
            UITextField buttonText = loginPanel.transform.Find("btAccept/tfTextfield").GetComponent<UITextField>();
    ...
    void OnEnable()
    {
        ...
        {
            case McSocialApiUtils.ScoreType.Weekly: scoreTypeButton = transform.Find("TopCenterButtons/ToggleData/WeeklyButton").GetComponent<UIButton>(); break;
            case McSocialApiUtils.ScoreType.Monthly: scoreTypeButton = transform.Find("TopCenterButtons/ToggleData/MonthlyButton").GetComponent<UIButton>(); break;
            case McSocialApiUtils.ScoreType.Latest: scoreTypeButton = transform.Find("TopCenterButtons/ToggleData/AllTimeButton").GetComponent<UIButton>(); break;
        }
        switch (currentScoreFilter)
        {
            case McSocialApiUtils.ScoreFilter.Friends: scoreFilterButton = transform.Find("TopCenterButtons/ToggleArea/FriendsButton").GetComponent<UIButton>(); break;
            case McSocialApiUtils.ScoreFilter.Country: scoreFilterButton = transform.Find("TopCenterButtons/ToggleArea/CountryButton").GetComponent<UIButton>(); break;
            case McSocialApiUtils.ScoreFilter.Global: scoreFilterButton = transform.Find("TopCenterButtons/ToggleArea/GlobalButton").GetComponent<UIButton>(); break;
        }
    ...
    void Signal_OnEnter(UIPage page)
    {
        ...
        transform.Find("TopCenterButtons/ToggleArea/CountryButton").GetComponentInChildren<UITextField>().ApplyParameters();
         transform.Find("TopCenterButtons/ToggleArea/FriendsButton").GetComponentInChildren<UITextField>().ApplyParameters();
         transform.Find("TopCenterButtons/ToggleArea/GlobalButton").GetComponentInChildren<UITextField>().ApplyParameters();
         transform.Find("TopCenterButtons/ToggleData/AllTimeButton").GetComponentInChildren<UITextField>().ApplyParameters();
         transform.Find("TopCenterButtons/ToggleData/MonthlyButton").GetComponentInChildren<UITextField>().ApplyParameters();
         transform.Find("TopCenterButtons/ToggleData/WeeklyButton").GetComponentInChildren<UITextField>().ApplyParameters();
     }
