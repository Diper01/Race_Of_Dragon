...
public class UISkipMissionPopup : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        transform.Find("content/step1/OkButton/tfTextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("skip_popup_upgrade");
        transform.Find("content/step2/CancelButton/tfTextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("cancel");
    }
...
*/
    ...
    void OnBackButtonAction()
    {
        ...
        if (transform.Find("content/step1/OkButton") != null)
            okButton = transform.Find("content/step1/OkButton").GetComponent<UIButton>();
