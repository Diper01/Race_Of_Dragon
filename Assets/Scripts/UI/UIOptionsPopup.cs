...
public class UIOptionsPopup : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tutorialOff = btTutorial.transform.Find("icon_check_no").gameObject;
        tutorialOn = btTutorial.transform.Find("icon_check_yes").gameObject;
        ...
        soundsOff = btSounds.transform.Find("icon_sound_off").gameObject;
        soundsOn = btSounds.transform.Find("icon_sound_on").gameObject;
        ...
        musicsOff = btMusics.transform.Find("icon_music_off").gameObject;
        musicsOn = btMusics.transform.Find("icon_music_on").gameObject;
        ...
        transform.Find("content/tfVersionNum").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("version") + versionNumber;
        ...
        transform.Find("content/OptionsObjects/TutorialObjects/tfTutorialLabel").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("tutorial");

        OnTheRunUITransitionManager.Instance.InitializeBackground( transform.Find("background/bg_gradient") );
...
/*#if UNITY_ANDROID
    ...
    void Signal_OnLanguageRelease(UIButton button)
    {
        button.GetComponent<LanguageController>().ChangeLanguage();
    }
