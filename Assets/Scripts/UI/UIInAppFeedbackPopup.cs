...
public class UIInAppFeedbackPopup : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        purchaseAnimObj = transform.Find("icon_purchase").gameObject;
        okButton = transform.Find("OkButton").gameObject;
        transform.Find("OkButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("ok");
    ...
    {
        transform.Find("popupTextField").GetComponent<UITextField>().text = text;
    }
