...
public class UITierItem : MonoBehaviour
{
    ...
    {
        GameObject coinIco = BuyButton.transform.Find("coin").gameObject;
        GameObject diamondIco = BuyButton.transform.Find("diamond").gameObject;
        UITextField tf = BuyButton.transform.Find("tfTextfield").gameObject.GetComponent<UITextField>();
    ...
    public void Initialize(int _tierId)
    {
        ...
        BuyButton.transform.Find("coin").gameObject.SetActive(false);
#else
        ...
        if (dataLoader.GetTiersCurrencies()[tierId] == PriceData.CurrencyType.FirstCurrency)
			LockedArea.transform.Find("btBuyTier/btBuyTierbtn/diamond").gameObject.SetActive(false);
