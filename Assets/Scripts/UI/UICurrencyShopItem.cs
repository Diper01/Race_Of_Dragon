...
public class UICurrencyShopItem : MonoBehaviour
{
    ...
    void FindObjects()
    {
        purchaseButton = transform.Find("PurchaseButton").gameObject.GetComponent<UIButton>();
        tfPrice = purchaseButton.transform.Find("tfPrice").gameObject.GetComponent<UITextField>();
        bestValue = transform.Find("BestValue").gameObject;
        specialOffer = transform.Find("SpecialOffer").gameObject;
        tfQuantity = transform.Find("tfQuantity").gameObject.GetComponent<UITextField>();
        tfOldQuantity = transform.Find("tfOldQuantity").gameObject.GetComponent<UITextField>();
        ...
        if (fuelGroup != null)
        {
            tfFuelQuantity = transform.Find("FuelGroup/tfQuantity").gameObject.GetComponent<UITextField>();
            fuelGroup.SetActive(false);
        }
        if (fuelFreezeGroup != null)
        {
            tfFuelFreezeText = transform.Find("FuelFreezeGroup/tfText").gameObject.GetComponent<UITextField>();
            tfFuelFreezeTime = transform.Find("FuelFreezeGroup/tfTime").gameObject.GetComponent<UITextField>();
    ...
    public void ActivateSpecialOffer(bool activate)
    {
        ...
        if(activate)
        {
            specialOffer.transform.Find("label").gameObject.GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("popular_tag");
        }
    }
    ...
    public void SetType(UICurrencyPopup.ShopPopupTypes curr, bool showDiamondIcon)
    {
        ...
        purchaseButton.transform.Find("diamond").gameObject.SetActive(showDiamondIcon);
    ...
    {
        Transform tr = transform.Find("Background_ice");
        if (tr!=null)
        {
            fuelFreezeGroup.SetActive(active);
            freezeObjects = transform.Find("Background_ice").gameObject;
