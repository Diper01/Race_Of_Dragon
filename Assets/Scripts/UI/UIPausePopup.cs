...
public class UIPausePopup : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        missionPanel = transform.Find("Layout1/MissionPanelPopup").gameObject;
        OnTheRunUITransitionManager.Instance.InitializeBackground(transform.Find("bg_black_gradient"));
    ...
    void OnEnable()
    {
        ...
        restartButton = transform.Find("ReplayButton").GetComponent<UIButton>();
...
//			Debug.LogWarning("devo resumare musica");
    ...
    {
        UIButton pauseButton = transform.Find("ResumeButton").GetComponent<UIButton>();
