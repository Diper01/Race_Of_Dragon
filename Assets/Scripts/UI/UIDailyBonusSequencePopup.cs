...
public class UIDailyBonusSequencePopup : MonoBehaviour
{
    ...
    void Signal_OnEnter(UIPopup popup)
    {
        if (dailyBonusPopup == null)
            dailyBonusPopup = Manager<UIRoot>.Get().gameObject.transform.Find("DailyBonusPopup").GetComponent<UIDailyBonusPopup>();
        ...
        buyButton.transform.Find("tfTextfield").GetComponent<UITextField>().text = buyStreakBonusCost.ToString();
        buyButton.transform.Find("coin").gameObject.SetActive(currency==PriceData.CurrencyType.FirstCurrency);
        buyButton.transform.Find("diamond").gameObject.SetActive(currency==PriceData.CurrencyType.SecondCurrency);
        skipButton.transform.Find("TextField").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("skip");
...
*/
    ...
    {
        UIButton okButton = transform.Find("content/content/OkButton").GetComponent<UIButton>();
