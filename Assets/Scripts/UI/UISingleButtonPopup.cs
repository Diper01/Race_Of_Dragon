...
public class UISingleButtonPopup : MonoBehaviour
{
    ...
    void OnEnable()
    {
        interfaceSounds = FindObjectOfType<OnTheRunInterfaceSounds>();
    ...
    void Signal_QUIT(UIButton button)
    {
        Application.Quit();
    }

    void Signal_STAY(UIButton button)
    {
        this.gameObject.GetComponentInParent<QuitScript>().Stay();
    }
    ...
    void OnBackButtonAction()
    {
        ...
        if (transform.Find("content/CancelButton") != null)
            cancelButton = transform.Find("content/CancelButton").GetComponent<UIButton>();

        UIButton okButton = null;
        if (transform.Find("content/OkButton") != null)
            okButton = transform.Find("content/OkButton").GetComponent<UIButton>();
