...
public class UIMissionsPanel : MonoBehaviour
{
    ...
    protected void StartPanelAnimation(OnTheRunSingleRunMissions.MissionType type)
    {
        ...
        { 
            transform.Find("titleText").gameObject.GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("mission_completed");
            transform.Find("missionText").gameObject.GetComponent<UITextField>().text = missionCompleted.description;
        }
        else
        {
    ...
    void Start()
    {
        ...
        transform.Find("titleText").gameObject.GetComponent<UILayoutAndScaling>().UpdateLayoutAndScaling(heightScale, aspectScale);
        transform.Find("missionText").gameObject.GetComponent<UILayoutAndScaling>().UpdateLayoutAndScaling(heightScale, aspectScale);
    }
