...
public class UIHighscoresPopup : MonoBehaviour
{
    ...
    {
        transform.Find("content/OkButton").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_back");

        transform.Find("content/title").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_highscores_title");
        transform.Find("content/description").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("web_highscores_description");

        transform.Find("content/location1/tfTextField").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("europeanCarsTitle");
        transform.Find("content/location2/tfTextField").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("orientalCarsTitle");
        transform.Find("content/location3/tfTextField").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("americanCarsTitle");
        transform.Find("content/location4/tfTextField").GetComponentInChildren<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("muscleCarsTitle");
        ...
        for (int i = 0; i < comingSoonObjects.Length; ++i)
        {
            ...
            transform.Find("content/location" + (i + 1)).GetComponent<BoxCollider2D>().enabled = !disable;
            transform.Find("content/location" + (i + 1)).GetComponent<UIButton>().State = disable ? UIButton.StateType.Disabled : UIButton.StateType.Normal;
        }
    }
