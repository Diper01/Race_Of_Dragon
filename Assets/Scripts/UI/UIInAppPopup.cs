...
public class UIInAppPopup : MonoBehaviour
{
    ...
    void AddShopElements()
    {
        ...
        UINineSlice shopElementBg = firstElement.transform.Find("Background_normal").GetComponent<UINineSlice>();
    ...
    void FillShopElementData(GameObject shopElement, int elementIndex)
    {
        ...
        shopElement.transform.Find("Badge/BadgeTextfield").GetComponent<UITextField>().text = Manager<UIRoot>.Get().FormatTextNumber(currBooster.quantity);
        shopElement.transform.Find("Price/PriceTextField").GetComponent<UITextField>().text = Manager<UIRoot>.Get().FormatTextNumber((int)currBooster.priceData.Price);
        shopElement.transform.Find("Price/Currency/coin").gameObject.SetActive(currBooster.priceData.Currency==PriceData.CurrencyType.FirstCurrency);
        shopElement.transform.Find("Price/Currency/diamond").gameObject.SetActive(currBooster.priceData.Currency == PriceData.CurrencyType.SecondCurrency);

        shopElement.transform.Find("Background_normal").gameObject.SetActive(!currBooster.equipped);
        shopElement.transform.Find("Background_active").gameObject.SetActive(currBooster.equipped);
        ...
        {
            shopElement.transform.Find("Badge").gameObject.SetActive(false);
        }
    }
