...
public class UIButtonsBar: MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        SpinWheelItem = transform.Find("SpinWheelButton").gameObject;
        OptionsWebItem = transform.Find("btOptionsWeb").gameObject;
        HelpWebItem = transform.Find("btHelpWeb").gameObject;
#if !UNITY_WEBPLAYER
    ...
    void OnEnable()
    {
        transform.Find("SpinWheelButton/text").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("spin");
        transform.Find("btRankings/tfLabel").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("ranking");
        transform.Find("btTrucks/tfLabel").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("special_btn");
        transform.Find("btTiers/tfLabel").GetComponent<UITextField>().text = OnTheRunDataLoader.Instance.GetLocaleString("tiers_btn");
#if UNITY_WEBPLAYER
    ...
    void RefreshSpinWheelButton()
    {
        ...
        Manager<UIRoot>.Get().SetupWheelButtonBounce(transform.Find("SpinWheelButton").gameObject);
    }
    ...
    public void UpdateSpinWheelButton()
    {
        ...
        {
            transform.Find("SpinWheelButton/Remaining").gameObject.SetActive(true);
            transform.Find("SpinWheelButton/Remaining/tfRemaining").GetComponent<UITextField>().text = remainingSpinds.ToString();
        }
        else
            transform.Find("SpinWheelButton/Remaining").gameObject.SetActive(false);
    }
    #endregion
}