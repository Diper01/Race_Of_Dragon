...
public class UISaveMePopup : MonoBehaviour
{
    ...
    void AddPopupElements()
    {
        ...
        for (int i = 0; i < buttonsNumber; ++i)
        {
            ...
            timeBar = currButton.transform.Find("Time/Bar/bar_orange_bg");
    ...
    void Signal_OnShow(UIPopup popup)
    {
        ...
        timeBar = selectedButton.button.transform.Find("Time/Bar/bar_orange_bg"); //saveMeButtonGO.transform.FindChild("Time/Bar/bar_orange_bg");
        timeBar.localScale = Vector3.one;
    ...
    void OnLaunchBestMetersFlyer()
    {
        ...
        UITextField tfText = bestMeters.transform.Find("TextLabel").GetComponentInChildren<UITextField>();
    ...
    void OnLaunchYourMetersFlyer()
    {
        ...
        UITextField tfText = yourMeters.transform.Find("TextLabel").GetComponentInChildren<UITextField>();
