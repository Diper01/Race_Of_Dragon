...
//    protected int androidUnityAdsPriority;
    ...
    */
    ...
    {
        //.Assert(node.tagName.Equals("car"));
    ...
    protected void ParseConfigXML(string dataText, bool checkVersion)
    {
        ...
        foreach (XMLNode record in root.children)
        {
            ...
            {
                bool inter_enabled = record.GetAttributeAsBool("interstitials_are_enabled", true);
...
//                        fpsIsEnabled = node.GetAttributeAsString("value", "false").Equals("true") ? true : false;
					...
					{
						facebookPageLink = node.GetAttributeAsString("value", "https://www.facebook.com/bidostudio1211");
                    }
