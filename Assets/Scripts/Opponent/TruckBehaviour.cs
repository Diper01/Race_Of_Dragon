...
public class TruckBehaviour : MonoBehaviour
{
    ...
    void InitializeTruck()
    {
        ...
        {
            gameObject.transform.Find("changeCarTrigger").GetComponent<ChangeCarBehaviour>().TriggerActive = true;
            ...
            if (true) //fakeCarInstance == null)
            {
                ...
                fakeCarInstance.transform.localPosition = gameObject.transform.Find("carPlaceholder").transform.localPosition;
                fakeCarInstance.transform.localRotation = gameObject.transform.Find("carPlaceholder").transform.localRotation;
    ...
    void InitializeTruckForGarage(int index)
    {
       ...
       /* if (spawnManager == null)
        ...
        GameObject shadow = gameObject.transform.Find("veh_shadow").gameObject;
