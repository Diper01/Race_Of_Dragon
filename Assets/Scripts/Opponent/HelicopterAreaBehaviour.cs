...
public class HelicopterAreaBehaviour : MonoBehaviour
{
    ...
    void FindPlayerKinematics()
    {
        ...
        //.Assert(playerGO != null, "Could not find GameObject with tag \"Player\"");

        playerKinematics = playerGO.GetComponent<PlayerKinematics>();
        //.Assert(playerKinematics != null, "Could not find PlayerKinematics component in Player GameObject");
    }
